...
void setup(void) {
  ...
  digitalWrite(led, 0);
  Serial.begin(115200);
// Set constant IP address and subnet mask
...
//
//    // Add greeting messages to the JSON document
//    JsonArray greetings = jsonDoc.createNestedArray("greetings");
//    greetings.add("Hello");
//    greetings.add("How are you");
//    greetings.add("I am Fine");
//    greetings.add("What are you Doing");
//    greetings.add("Working ");
